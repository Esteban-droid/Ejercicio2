public class StringDemo {
     ...
     public static void main(String[] args) {
        ...
        String ninja = "NTT Data es Increíble!";
        ...
        // Imprimirá mi nombre es Michael
        ...
        //En el lugar de %.2f se esperá un dato de tipo float. El número 2 indica que se colocarán dos números a la derecha del punto decimal.
